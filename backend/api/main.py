...
from api.routes import data, analysis, monitor, history, realtime, orderbook, backtest_cpp, prediction, news, auth, ws, fine_tune, stock_pools, walk_forward, screener, agent, knowledge, data_monitor, deep_history, settings, crypto_strategy, arena
...
app.include_router(arena.router, dependencies=_auth)  # 交易终端只读出口（S7）
